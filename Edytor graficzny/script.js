...
function saveFile() {
    ...
    document.getElementById('jpg').src = image;
}

function Scale(event) {
    Image = document.getElementById("canvas");
    Filter = document.getElementById("GreyScale").value;
    Image.style.WebkitFilter = "grayscale(" + Filter * 1 + "%)"
...
function Brightness(event) {
    Image = document.getElementById("canvas");
    Filter = document.getElementById("Brightness").value;
    Image.style.WebkitFilter = "brightness(" + Filter * 1 + "%)"
